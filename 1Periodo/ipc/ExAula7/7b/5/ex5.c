...
int main()
{
    ...
    if (la != cb) {
        printf("Para ser possivel multiplicar duas matrizes, o numero de linhas\nde uma deve ser o mesmo que o numero de colunas da outra. Tente novamente!\n");
    } else {
        ...
        printf("O resultado da soma da multiplicacao entra A e B eh: \n");
        for (int i = 0; i < la; i++) {
            for (int j = 0; j < cb; j++) {
                printf("%d ", ab[i][j]);
            }
